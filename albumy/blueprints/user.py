...
from albumy.models import User, Photo, Collect, Notification
...
from albumy.forms.user import EditProfileForm, UploadAvatarForm, \
    CropAvatarForm, ChangeEmailForm, ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
...
def follow(username):
    ...
    if current_user.is_following(user):
        flash(f'Already followed {username}', 'info')
...
def show_followers(username):
    ...
    return render_template('user/followers.html', user=user, follows=follows, pagination=pagination)
...
def delete_account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Fuck off my site', 'success')
